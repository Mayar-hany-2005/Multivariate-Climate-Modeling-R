...
This project was developed as the **Final Capstone Project** for the **"Applied Multivariate Analysis"** course. Our team is proud to share that this work received an **A+ grade**, recognizing our excellence in advanced statistical modeling and multidimensional data analysis.
...
* **Exploratory Data Analysis (EDA):** Over 35 high-quality visualizations created using `ggplot2` to uncover hidden climate trends.
...
* **Advanced Statistics:** Applied MANOVA and Z-score standardization to compare relative intensity across seasons.
...
- **Key Libraries:** `tidyverse`, `ggplot2`, `corrplot`, `patchwork`, `scales`.

## 📁 Project Structure
- `data/`: Contains the `climate_change_dataset.csv` (Global climate & environmental records).
- `scripts/`: `R_climatechange_organized.ipynb` (Full analysis workflow).
- `report/`: `applied_3.pdf` (Detailed technical report with findings).
